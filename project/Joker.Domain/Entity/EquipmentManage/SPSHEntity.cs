...
namespace Joker.Domain.Entity.EquipmentManage
{
    ...
    /// SPSHEntity
    /// </summary>	
    public class SPSHEntity : IEntity<SPSHEntity>, ICreationAudited, IDeleteAudited, IModificationAudited
    {
        [DatabaseGenerated(DatabaseGeneratedOption.Computed)]
        public int F_No { get; set; }
        public string F_Id { get; set; }
        public string F_Data1 { get; set; }
        public bool? F_Data2 { get; set; }
        public string F_Data3 { get; set; }
        public DateTime? F_Data4 { get; set; }
